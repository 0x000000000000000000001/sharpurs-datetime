...
namespace Data.DateTime_;

public static class FFI {
    private static System.DateTime CreateUTC(long y, long mo, long d, long h, long m, long s, long ms) {
        return new System.DateTime((int)y, (int)mo, (int)d, (int)h, (int)m, (int)s, (int)ms, DateTimeKind.Utc);
    }
    ...
    public static double CalcDiff(Dictionary<string, object> rec1, Dictionary<string, object> rec2) {
    ...
    public static object AdjustImpl(Func<object, object> just, object nothing, double offset, Dictionary<string, object> rec) {
